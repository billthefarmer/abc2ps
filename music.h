...
float x;
{
  ...
  int sh_pos[8]={0,  24,15,27,18,9,21,12};
...
int nwl;
{
  ...
  if (do_tab) {
    PUT5("%.1f %.1f %.1f %.1f %.1f ln ", 0.0,
	 yword-cfmt.vocalfont.size/4, staffwidth,
	 yword-cfmt.vocalfont.size/4, 0.5);
    PUT5("%.1f %.1f %.1f %.1f %.1f ln ", 0.0,
	 yword+lskip-cfmt.vocalfont.size/4, 0.0,
	 yword-lskip-cfmt.vocalfont.size/4, 0.5);
    PUT5("%.1f %.1f %.1f %.1f %.1f ln ", staffwidth,
	 yword+lskip-cfmt.vocalfont.size/4, staffwidth,
	 yword-lskip-cfmt.vocalfont.size/4, 0.5);
...
FILE *fp;
{
  ...
  float realwidth,wid0,widv,lscale,lwidth,bpos;
